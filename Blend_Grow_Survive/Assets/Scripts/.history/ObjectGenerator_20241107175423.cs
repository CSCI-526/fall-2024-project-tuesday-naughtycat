...
//         {
//             new WaveDefinition { waveNumber = 1, normalEnemies = 10, archerEnemies = 0 },
//             new WaveDefinition { waveNumber = 2, normalEnemies = 15, archerEnemies = 0 },
//             new WaveDefinition { waveNumber = 3, normalEnemies = 10, archerEnemies = 5 }
//         };
...
//         {
//             created_objects.Add(m);
//             // Optionally, notify the player or other systems
//         }
//     }
...
//             if (created_enemies.Count == 0 && currentWaveEnemies >= totalEnemiesToSpawn)
//             {
//                 OnWaveCleared();
//             }
//         }
...
public class ObjectGenerator : MonoBehaviour
{
    ...
    public void RemoveObject(GameObject m, List<GameObject> created_objects)
    {
        if (created_objects.Contains(m))
        {
            ...
            // Check if the wave is cleared after an enemy is removed
            if (created_enemies.Count == 0 && !isWaveActive && currentWaveEnemies >= waveDefinitions[currentWave - 1].totalEnemies)
            {
                OnWaveCleared();
            }
        }
