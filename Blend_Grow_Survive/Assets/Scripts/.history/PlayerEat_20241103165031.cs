...
public class PlayerEat : MonoBehaviour
{
    ...
    public GameObject[] enemyArchers; // Array for EnemyArcher objects
    ...
    public void UpdateEnemyArcher() // New method to update EnemyArcher array
    {
        enemyArchers = GameObject.FindGameObjectsWithTag("EnemyArcher");
    }
    ...
    public void CheckEnemyArcher() // New method to check EnemyArcher interactions
    {
        CheckGameObject(enemyArchers);
    }
    ...
    void Start()
    {
        ...
        IncokeRepeating("CheckEnemyArcher", 0, 0.1f);
