...
public class PlayerHealth : MonoBehaviour
{
    ...
    public float sizeReductionAmount = 0.1f; // Amount to reduce player size per hit
    ...
    void ReducePlayerSize()
    {
        ...
        // Ensure player size doesn't go below a minimum scale
        float minScale = 0.5f;
