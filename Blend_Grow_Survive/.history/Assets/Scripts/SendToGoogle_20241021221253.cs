...
public class SendToGoogle : MonoBehaviour
{
    ...
    private IEnumerator PostMetrics(string sessionID, string timeSurvived, string enemiesDefeated)
    {
        ...
        form.AddField("entry.1884265043", sessionID);  // Replace with actual Session ID entry
        form.AddField("entry.298833661", timeSurvived);  // Replace with actual Time Survived entry
        form.AddField("entry.1674722008", enemiesDefeated);  // Replace with actual Enemies Defeated entry
